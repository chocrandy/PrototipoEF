...
{
    public partial class mantenimiento_proveedores : Form
    {
        string usuario = "";        
        public mantenimiento_proveedores(String usuarioActivo)
        {
            InitializeComponent();
            usuario = usuarioActivo;
            string[] alias = { "Cod. Proveedor", "Nombre", "Dirección", "Teléfono", "NIT", "Estado" }; // Arreglo de nombres para campos
            ...
            navegador1.asignarTabla("proveedores"); // tabla principal
            navegador1.asignarNombreForm("Proveedores"); // Titulo y nombre del form
        }

...
namespace CapaVistaFRM
{
    ...
    {
        string usuario = "";        
        public mantenimiento_productos(String usuarioActivo)
        {
            InitializeComponent();
            usuario = usuarioActivo;
            string[] alias = { "Cod. Producto", "Nombre", "Linea", "Marca", "Existencia", "Estado" }; // Arreglo de nombres para campos
            ...
            navegador1.asignarComboConTabla("lineas", "nombre_linea", 1); 
            navegador1.asignarComboConTabla("marcas", "nombre_marca", 1); 
            navegador1.asignarTabla("productos"); // tabla principal
            navegador1.asignarNombreForm("Productos"); // Titulo y nombre del form
        }

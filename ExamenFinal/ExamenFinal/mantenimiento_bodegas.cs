...
{
    public partial class mantenimiento_bodegas : Form
    {
        string usuario = "";        
        public mantenimiento_bodegas(String usuarioActivo)
        {
            InitializeComponent();
            usuario = usuarioActivo;
            string[] alias = { "Cod. Bodega", "Nombre", "Estado" }; // Arreglo de nombres para campos

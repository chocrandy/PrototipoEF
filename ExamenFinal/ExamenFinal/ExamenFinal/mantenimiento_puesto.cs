...
{
    public partial class mantenimiento_puesto : Form
    {
        string usuario = "";        
        public mantenimiento_puesto(String usuarioActivo)
        {
            InitializeComponent();
            usuario = usuarioActivo;
            string[] alias = { "Cod. Puesto", "Nombre", "Estado" }; // Arreglo de nombres para campos

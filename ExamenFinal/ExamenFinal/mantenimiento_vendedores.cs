...
namespace CapaVistaFRM
{
    ...
    {
        string usuario = "";        
        public mantenimiento_vendedores(String usuarioActivo)
        {
            InitializeComponent();
            usuario = usuarioActivo;
            string[] alias = { "Cod. Vendedor", "Nombre", "Dirección", "Teléfono", "NIT", "Estado" }; // Arreglo de nombres para campos
            ...
            navegador1.asignarTabla("vendedores"); // tabla principal
            navegador1.asignarNombreForm("Vendedores"); // Titulo y nombre del form
        }

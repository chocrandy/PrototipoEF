...
{
    public partial class mantenimiento_lineas : Form
    {
        string usuario = "";        
        public mantenimiento_lineas(String usuarioActivo)
        {
            InitializeComponent();
            usuario = usuarioActivo;
            string[] alias = { "Cod. Linea", "Nombre", "Estado" }; // Arreglo de nombres para campos
            ...
            navegador1.asignarTabla("lineas"); // tabla principal
            navegador1.asignarNombreForm("Lineas"); // Titulo y nombre del form
        }
